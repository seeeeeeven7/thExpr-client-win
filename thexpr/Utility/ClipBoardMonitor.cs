...
namespace thexpr.Utility
{
    public class ClipBoardMonitor : NativeWindow
    {
        ...
        public event NewFileDropListHandler NewFileDropList;
        public delegate void NewFileDropListHandler(StringCollection fileDropList);
            ...
            switch (m.Msg)
            {
                case WM_DRAWCLIPBOARD:
                    ...
                    if (Clipboard.ContainsFileDropList())
                    {
                        ...
                        if (this.NewFileDropList != null)
                        {
                            this.NewFileDropList(fileDropList);
                        }
                    }
